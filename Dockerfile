...
RUN cd /tmp \
    ...
    "linux/arm/v7") wget -O qbittorrent.zip https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/release-5.0.0.10/qbittorrent-enhanced-nox_arm-linux-musleabihf_static.zip ;; \
    "linux/arm/v6") wget -O qbittorrent.zip https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/release-5.0.0.10/qbittorrent-enhanced-nox_arm-linux-musleabi_static.zip ;; \
